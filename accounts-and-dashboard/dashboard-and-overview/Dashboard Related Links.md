...
description: >-
  ...
  self-service tasks like password changes, e-statements, and scheduled transfers.
---
...
Click **Direct Deposit Form** in the Related Links sidebar. The Payroll Direct Deposit Form loads, pre-populated with the member's Account Number Identification, Member Name, Account Type, and Credit Union Routing / Transit Number. The member can print or save this form to provide to their employer.
