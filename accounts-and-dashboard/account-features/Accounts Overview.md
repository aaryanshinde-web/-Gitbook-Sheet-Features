---
description: "View all accounts and memberships in a single dashboard with grouped and filtered views"
---
...
The Account Overview is the main Accounts page, accessed by clicking "Accounts" in the top navigation bar. It displays all accounts under the member's membership — Checking, Savings, Credit Card, Mortgage, Loans, Line of Credit, and Certificate accounts. The page features 4 tabs: Account group (groups by account type), Member review, All transactions, and Membership association. Each account row shows the account name, masked number, balance, and action buttons including Recent Transactions, Account Details, Transfers, Deposit Direct/Deposit Check, Make Payment, and Account Enquiry. A Quick Transfer widget and Upcoming Payments section appear on the right sidebar.

## Key Use Cases

- View all account balances at a glance
- Check a specific account type or group
- Access accounts across multiple memberships
- Initiate account-level actions (transfers, deposits, payments)
- Review upcoming payments and scheduled transfers
