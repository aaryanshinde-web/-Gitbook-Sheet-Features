...
The Accounts and Memberships page allows members to view and manage their membership associations and open additional accounts. It displays the current membership details and provides options to add or manage additional memberships linked to the member's profile. Members access this page from the More menu in the top navigation. The page includes a link to open new accounts or apply for new memberships at Tyfone, with a button to proceed to the external application site.
