---
description: nFinia Digital Banking · CSUM-04 · Account Detail — All Account Types
---

# Account Detail — All Account Types

> **Module:** nFinia Digital Banking → Accounts → [Account]  |  **Reference:** CSUM-04
...
All account detail pages follow a consistent layout: balance summary at top, transaction history in the main panel, and related actions/links in the side panel or at the bottom. This consistency reduces the learning curve for The member managing multiple account types.
...
| Related Reports | CSUM-03 (Account Overview), CSUM-14 (Loan Payments), CSUM-05 (eDocuments) |
...
| ---------------------------- | ---------------------------------------------------------- | -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Daily Balance Monitoring     | The member checking account status                            | Open account detail for real-time balance and recent activity              | Instant financial status without contacting CU                                                                                                                                                                    |
| Stop Payment Request         | The member stopping an issued check                           | Open checking detail > Related Links > Stop Payment                        | Prevents a check from clearing without branch visit                                                                                                                                                               |
| Loan Payment Tracking        | The member monitoring loan status                             | Open loan account detail to see principal, interest, and payment history   | Full loan amortization visibility in one screen                                                                                                                                                                   |
| CD Maturity Election         | The member with maturing certificates                         | Open CD account detail > Renewal Options before maturity date              | Self-service CD renewal election without branch appointment                                                                                                                                                       |
| Round Up to Savings          | The member building savings automatically                     | Enable Round Up feature in account settings to round up debit transactions | Passive savings accumulation from everyday spending                                                                                                                                                               |
| 
## 03 · Step-by-Step Guide
 | *Navigation: Dashboard > Accounts > tap any account tile.* | **Step 1 — Start from Dashboard**                                          | you begins at the Dashboard after logging in. The Dashboard displays all account balances, upcoming payments, quick-action tiles, and the top navigation bar with links to Accounts, Move Money, and More. |
