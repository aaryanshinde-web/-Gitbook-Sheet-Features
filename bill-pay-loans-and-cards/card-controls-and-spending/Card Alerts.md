...
| |                                                                                                         |
| ------------------------------------------------------------------------------------------------------- |
| _📍 Navigation path: Banking › Cards › \[select card] › Card Details › Card Controls › Card Alerts tab_ | | Step 1 Open Card Details |
| From the nFinia top navigation, select Cards. Locate the card you want to configure and click Card Controls at the bottom of that card tile. This opens the Card Details page. | <figure><img src="/.gitbook/assets/Card_Alerts_img1.png" alt="" width="480"><figcaption></figcaption></figure> |
...
| <figure><img src="/.gitbook/assets/Card_Alerts_img2.png" alt="" width="340"><figcaption></figcaption></figure> | Step 3 Configure Spend Alerts |
...
| |                                  |
| -------------------------------- |
| **■ Merchant Category Controls** | | The Merchant Categories section lets you control spending by merchant type. Toggle any category Off to block transactions at matching merchants instantly. |
