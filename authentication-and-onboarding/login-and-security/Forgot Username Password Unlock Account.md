...
The self-service account recovery features — Forgot User ID, Forgot Password, and Unlock Account — allow members to restore digital banking access without contacting the credit union or visiting a branch. For business members who may manage multiple digital banking credentials or return to a platform after an extended absence, these recovery flows are the fastest path to restored access — typically completing in under two minutes using identity verification questions or OTP confirmation against the registered contact on file.
