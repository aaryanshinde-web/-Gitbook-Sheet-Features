...
<img src="/.gitbook/assets/fics-001.jpg" alt="Mortgage landing page — sidebar navigation and empty state" style="max-width:700px;width:100%">

When you have multiple FICS accounts, a **Select Account** dropdown appears populated with all linked FICS loan accounts.

<img src="/.gitbook/assets/fics-002.jpg" alt="FICS loan account selector dropdown" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-003.jpg" alt="Mortgage account detail — loan summary, Pay Now, Upcoming Payments, Quick Transfer" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-004.jpg" alt="Mortgage transaction history list" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-005.jpg" alt="Expanded transaction detail with Download button" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-006.jpg" alt="Loan Information screen showing all five tabs" style="max-width:700px;width:100%">

<img src="/.gitbook/assets/fics-007.jpg" alt="About This Loan — full loan details with APR, payment breakdown" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-008.jpg" alt="Update mortgage contact information modal" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-009.jpg" alt="Balances tab — full balance breakdown and year-to-date totals" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-010.jpg" alt="Downloaded balance PDF — year-to-date totals report" style="width:550px;max-width:100%">
...
<img src="/.gitbook/assets/fics-011.jpg" alt="Account Notes tab — search, date filter, and notes list" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-012.jpg" alt="Help tab — support contact info and secure messaging form" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-013.jpg" alt="Request Payoff Information form — OLB view with field tooltips" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-015.jpg" alt="Payoff request submitted — success confirmation banner" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-016.jpg" alt="External Link Warning — Pay Now SSO redirect confirmation" style="max-width:700px;width:100%">
...
<img src="/.gitbook/assets/fics-017.jpg" alt="Account Settings — Show/Hide a FICS loan account" style="max-width:700px;width:100%">
