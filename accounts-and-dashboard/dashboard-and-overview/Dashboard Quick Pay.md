...
The "From account" dropdown defaults to the primary checking account. Click it to change the source account if needed. The dropdown lists all accounts with their names, account numbers, and available balances.
...
### Step 5 — Review the Selected Account
...
### Step 6 — Click Transfer and Confirm
...
<figure><img src="/.gitbook/assets/quick-transfer-confirm.png" alt="" width="480"><figcaption></figcaption></figure>
