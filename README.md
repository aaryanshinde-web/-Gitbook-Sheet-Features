---
description: Official feature documentation for Diamond Credit Union's nFinia Digital Banking platform — covering all tracked features, vendor integrations, and reference guides.
...
# Diamond Credit Union — nFinia Digital Banking

Welcome to the **Diamond Credit Union nFinia Platform Documentation** — the single authoritative reference for all features, integrations, and technical specifications tracked in the Feature Documentation Tracking sheet.
...
| **Reference Documents** | Diamond CU Master Guide, Delegated Access, Certificate Management, Custom Account Grouping, Joint Owners & Beneficiary |
...
The **nFinia** digital banking platform from **Tyfone** powers Diamond Credit Union's member-facing digital experience across:
